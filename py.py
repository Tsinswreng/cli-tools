from ctypes import *
_path = "e:/_code/rime-tools/aot/bin/Release/net9.0/win-x64/publish/aot.dll"
#nativeLibrary = cdll.LoadLibrary("./native-demo/native-c#.dll")
nativeLibrary = cdll.LoadLibrary(_path)
ans = nativeLibrary.tsins_add__cdecl(1,2)
#ans = nativeLibrary.tsins_add__stdcall(1,2) #二者皆可
print(ans)
